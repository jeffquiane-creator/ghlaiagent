...
- People give phone numbers: "text 555-1234" or "text 2142903350"

PHONE NUMBER HANDLING:
- If user says "text [PHONE NUMBER]", use the phone number directly in SMS
- Phone numbers can be: "555-1234", "2142903350", "214-290-3350", "(214) 290-3350"
- Example: "text 2142903350 thanks" means send SMS directly to that phone number
- Don't search for a contact - just send to the number
...
- send_sms: "text john", "sms sarah", "message mike", "text 555-1234 hello"
- send_sms_to_number: "text [phone number] [message]" - sends directly to phone number
...
"text 2142903350 thank you"
{"action": "send_sms_to_number", "parameters": {"phone": "2142903350", "message": "thank you"}, "confirmation_message": "Texting 2142903350"}

"text sarah thanks"
{"action": "send_sms", "parameters": {"contact_name": "sarah", "message": "thanks"}, "confirmation_message": "Texting sarah"}
...
- If they say "text 555-1234 hello", send to that phone number directly
